...
namespace HideSeek.AI
{
    public sealed class ChaseAIInvestigationContext
    {
        ...
        public float CurrentAudioOccurredTime { get; private set; }
        public float CurrentAudioEvidenceDuration { get; private set; }
        public float CurrentAudioAcceptedTime { get; private set; }
        public NOISE_TYPE CurrentAudioNoiseType { get; private set; }
        public GameObject CurrentAudioSourceObj { get; private set; }
        ...
        public void SetAudioInvestigation(
            ...
            float currentTime)
        {
            ...
            AudioSearchPosition = noiseData.Position;
            ...
            CurrentAudioOccurredTime = noiseData.OccurredTime;
            CurrentAudioEvidenceDuration = intensity >= CHASE_AI_CONFIG.StrongNoiseThreshold
                ? CHASE_AI_CONFIG.StrongNoiseEvidenceDuration
                : CHASE_AI_CONFIG.WeakNoiseEvidenceDuration;
            CurrentAudioAcceptedTime = currentTime;
            CurrentAudioNoiseType = noiseData.NoiseType;
            CurrentAudioSourceObj = noiseData.SourceObj;
        ...
        public void ClearAudioInvestigation()
        {
            ...
            CurrentAudioOccurredTime = 0f;
            CurrentAudioEvidenceDuration = 0f;
            CurrentAudioAcceptedTime = 0f;
            CurrentAudioNoiseType = default;
            CurrentAudioSourceObj = null;
